...
class ResNet(nn.Module):
    def __init__(self,
        ...
        # ops in the network
        self.conv1 = nn.Conv2d(input_chans,
                               64,
                               kernel_size=3,
                               stride=1,
                               padding=1,
    ...
    def _freeze_stages(self):
        ...
        stage_mapping = [[self.conv1, self.bn1], [self.layer1], [self.layer2],
...
def load_pretrained_model(model, model_id):
    ...
    missing_keys, unexpected_keys = model.load_state_dict(model_zoo.load_url(
        model_urls[model_id]),
                                                          strict=False)
    if missing_keys:
        print("Missing keys:")
